...
const translations = {
  cantonese: {
    ...
    loginSubtitle: '输入你嘅邮箱地址，我们会发送验证码',
    verificationSubtitle: '请输入发送到你邮箱嘅6位验证码',
    emailLabel: '邮箱地址',
    ...
    verificationSentSubtitle: '我们已向 {email} 发送验证码',
    nextStepsTitle: '下一步',
    step1: '检查你嘅邮箱收件箱',
    step2: '输入6位验证码',
    step3: '点击验证按钮',
    ...
    verificationSent: '验证码已发送，请检查你嘅邮箱！',
    sendFailed: '发送失败',
